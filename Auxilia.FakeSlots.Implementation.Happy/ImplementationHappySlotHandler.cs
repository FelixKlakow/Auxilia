...
namespace Auxilia.FakeSlots.Implementation.Happy;

public sealed class ImplementationHappySlotHandler : ISlotHandler
{
    public void Register(IServiceCollection services, string slotName, Type serviceType, SlotConfiguration configuration)
    {
        switch (slotName)
        {
            ...
            case "implementation-agent":
                services.AddKeyedScoped<IAiAgent>(slotName, (_, _) => new ImplementationAgent());
                break;
