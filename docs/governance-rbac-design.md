...
- **AccountBundle** already exists conceptually (ARCHITECTURE.md §11); governance adds the ownership link and bundle-level constraints (purpose restrictions, quotas for AI bundles). The concrete credential store is the Core **connector** (encrypted at rest).
