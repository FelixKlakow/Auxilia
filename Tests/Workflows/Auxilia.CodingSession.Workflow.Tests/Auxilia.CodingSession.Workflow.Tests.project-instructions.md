...
Unit tests (all `Category=Unit`) for `Source/Workflows/Auxilia.CodingSession.Workflow` (the interactive tmux/ttyd coding-session workflow).
...
## File / Folder Map
```
Tests/Workflows/Auxilia.CodingSession.Workflow.Tests/
