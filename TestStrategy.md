...
**Projects:** `Auxilia.BackendService.Tests/ComponentTests/`
...
| Environment                 | Containers                | Test class                  |
|-----------------------------|---------------------------|-----------------------------|
| `BackendServiceEnvironment` | RabbitMQ + BackendService | `BackendServiceSystemTests` |
