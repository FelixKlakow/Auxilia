...
/// <summary>
/// In-memory fake message bus for component tests. Thread-safe. Records published messages so
/// tests can assert on them and delivers exchange messages fed via
/// <see cref="SimulateReceivedAsync{T}" /> to registered subscribers.
/// </summary>
